...
public class MainActivity2 extends BaseActivity implements IssueListener {
	...
	public void initWidget(Bundle savedInstanceState) {
		...
		mImageView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				...
				Utils.startActivity(MainActivity2.this, ImageActivity.class, data);
				overridePendingTransition(R.anim.fade_in, R.anim.a_to_b_of_out_1);
			}
		});
		TopBar topBar = new TopBar(this, AVUser.getCurrentUser().getUsername());
	...
	public void widgetClick(View v) {
		...
		case R.id.upload_picture:
			...
			View view2 = LayoutInflater.from(MainActivity2.this).inflate(R.layout.custom_view, null);
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parentView, View view, int position, long id) {
					...
					switch (position) {
					case 0:
						Utils.startActivityForResult(MainActivity2.this, ImageLocalActivity.class, 0x11); // 本地相册
						break;
					case 1:
		...
		case R.id.setting_imageview:
			Utils.startActivity(MainActivity2.this, SettingActivity.class);
			break;
		case R.id.go_share_btn:
//			Utils.startActivity(MainActivity.this, SendMessageActivity.class);
			Utils.startActivity(MainActivity2.this, ShareListActivity.class);
			break;
